...
export function build({ key, prose, block }) {
  ...
  return {
    ...
    seoTitle: "How to Buy a Home in Garland, Texas",
    seoDescription:
    ...
    status: "published",
    categorySlug: "garland-field-guide",
    ...
    featuredImage: {
      ...
      alt: "A person holding a set of keys with a small house keyring in front of an open front door at dusk",
      caption: "Closing is the last step of a plan that starts long before the listing search.",
      focalPoint: "62% 50%",
    },
    body: [
      ...
      block.callout({
        tone: "caution",
        heading: "Step 6: Understand Garland's specialized voucher option",
        content: [
          p(
      ...
      block.checklist({
        heading: "Questions to ask about a preapproval",
        items: [
          { label: "How long is the preapproval valid?" },
          { label: "What property-tax and insurance assumptions were used?" },
          { label: "Are mortgage insurance and association dues included?" },
          { label: "What changes could affect the result?" },
          { label: "Which documents must remain current?" },
        ],
      }),

      block.richText([p("A preapproval is not a final approval. The property and transaction must qualify too.")]),
      ...
      block.callout({
        tone: "caution",
        heading: "Verify wire instructions before you send money",
        content: [
          p(
      ...
      block.areaGuideCta({
        ...
        href: "/areas/garland",
        label: "Continue with Debra's Garland homebuyer guide",
      }),
    ],
    faqs: [
      {
