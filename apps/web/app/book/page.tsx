...
export const metadata: Metadata = { title: "Schedule a Homebuyer Consultation", description: "Request a homebuyer consultation with Debra Allen.", alternates: { canonical: "/book" } }
  ...
  return <>
    ...
    <section className="py-12 md:py-16"><Container className="grid min-w-0 gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:gap-12">
      <div className="min-w-0">
        ...
        <div className="mt-8"><h2 className="font-serif text-2xl font-normal">Not ready to schedule?</h2><p className="mt-3 leading-7 text-muted-foreground">Use the free calculators and buyer resources first. Come back when you have a question worth discussing.</p><div className="mt-5 flex flex-col gap-3 text-sm font-semibold text-primary sm:flex-row sm:gap-6"><Link href="/resources/calculators/mortgage-payment" className="hover:underline">Mortgage calculator →</Link><Link href="/resources/calculators/affordability" className="hover:underline">Affordability calculator →</Link></div></div>
      </div>
      <div className="min-w-0 self-start border border-border bg-card p-6 sm:p-8"><h2 className="font-serif text-3xl font-normal">Request a consultation</h2><p className="mt-3 text-sm leading-6 text-muted-foreground">Complete the short form so Debra can understand what you would like to discuss. Do not include Social Security numbers, account numbers, or other sensitive financial information.</p><div className="mt-7"><ContactForm context="consultation" /></div></div>
    </Container></section>
  </>
}
