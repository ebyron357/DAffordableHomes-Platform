...
import { absoluteUrl, articleCanonical, buildArticleSchema, buildBreadcrumbSchema, buildFaqSchema } from "@/lib/cms/structured-data"
      ...
      {isDraft && (
        <div className="bg-warning text-warning-foreground">
          <Container className="flex flex-wrap items-center justify-between gap-3 py-2.5 text-sm">
            ...
            <a href="/api/preview/disable" className="font-semibold underline underline-offset-4">
              Exit preview
            </a>
          </Container>
        </div>
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <ul className="mt-4 divide-y divide-border">
                  {article.relatedLinks.map((link) => (
                    <li key={link._key}>
                      <Link href={link.href} className="group block py-4 first:pt-0 last:pb-0">
...
export { ARTICLE_REVALIDATE_SECONDS }
