 ...
 *
 * Newly published CMS articles become routable on the next deployment; the
 * publish webhook triggers one when VERCEL_DEPLOY_HOOK_URL is configured.
 */
...
function socialImageUrl(article: Article): string | undefined {
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: image ? [{ url: image, alt: (article.socialImage ?? article.featuredImage)?.alt ?? article.title }] : undefined,
    },
    twitter: {
