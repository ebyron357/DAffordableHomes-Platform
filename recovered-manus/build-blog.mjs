...
const blogBody = `<main id="main-content"><section class="hero"><div class="hero-inner debra-intro"><div><p class="eyebrow">HOMEBUYER RESOURCES</p><h1>Clear answers for the decisions ahead.</h1><p>Practical North Texas guidance to help you understand the process, prepare with confidence, and know what to ask next.</p></div><figure class="debra-photo"><img src="/manus-storage/debra-portrait_922a2df0.jpg" alt="Debra Allen, REALTOR® and D'Affordable Homes guide" width="720" height="960"><figcaption>Debra Allen, REALTOR®</figcaption></figure></div></section><section class="content" aria-labelledby="guides"><p class="eyebrow">FEATURED GUIDES</p><h2 id="guides" style="font:600 clamp(2rem,4vw,3.5rem)/1.1 'Playfair Display',serif">Start with the question in front of you.</h2><div class="cards">${cards}</div></section></main>`;
